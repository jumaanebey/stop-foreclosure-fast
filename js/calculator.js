...
function handleLeadFormSubmission(form) {
    ...
    submitToGoogleSheets(leadData)
        ...
        .catch(error => {
            ...
            alert('There was an error submitting your request. Please text us at (949) 565-5285 for immediate assistance.');
    ...
    form.innerHTML = `
        <div class="success-message">
            ...
            <div class="success-actions">
                <a href="sms:+1-949-565-5285?body=I just submitted a cash offer request for ${formatCurrency(calculatorData.desiredPrice)} for my property. I'd like to discuss this further." class="success-button">
                    💬 Text Now: (949) 565-5285
                </a>
