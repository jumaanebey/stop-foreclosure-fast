        ...
        const messageHtml = `
            <div class="ai-response urgent">
                ...
                <div class="contact-backup">
                    <p>Need immediate help? Call: <a href="tel:+1-949-328-4811">(949) 328-4811</a></p>
                </div>
            </div>
        `;
    ...
    fallbackProcessing(leadData) {
        ...
        const messageHtml = `
            <div class="ai-response fallback">
                ...
                <p>For immediate assistance: <a href="tel:+1-949-328-4811">(949) 328-4811</a></p>
            </div>
        `;
        this.displayMessage(messageHtml);
    }
...
function scheduleConsultation() {
    ...
    if (calendarElement) {
        ...
        window.location.href = 'tel:+1-949-328-4811';
    }
}
